...
CONFIG_DIR=config/planar_pushing/context_length_exp_adam_data_constant_model_size/robomimic_resnet18_init_tenth_lr/
CONFIG_NAME=5_obs.yaml
HYDRA_RUN_DIR=data/outputs/context_length_exp_adam_data_constant_model_size/robomimic_resnet18_init_tenth_lr/5_obs

# CONFIG_DIR=config/grasp_two_bins_flat/basic_training/
# CONFIG_NAME=24_obs.yaml
# HYDRA_RUN_DIR=data/outputs/grasp_two_bins_flat/basic_training/24_obs
