...
CONFIG_DIR=config/planar_pushing/context_length_exp_adam_data_resnet_plus_transformer/hierarchy_basic/
CONFIG_NAME=12_obs.yaml
HYDRA_RUN_DIR=data/outputs/context_length_exp_adam_data_resnet_plus_transformer/hierarchy_basic/12_obs
