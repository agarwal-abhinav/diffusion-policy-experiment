...
CONFIG_DIR=config/planar_pushing/context_length_exp_adam_data_resnet_plus_transformer/cls_token_only_causal/
CONFIG_NAME=5_obs.yaml
HYDRA_RUN_DIR=data/outputs/context_length_exp_adam_data_resnet_plus_transformer/cls_token_only_causal/5_obs
