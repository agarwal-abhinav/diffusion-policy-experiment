...
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/long_context_planar_pushing/single_mode/unet_cross_attention/4_original/constant_obs_steps_25_data/5_obs/normalizer.pt"
