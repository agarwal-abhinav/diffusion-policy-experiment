...
SOURCE_DIR="data/outputs/grasp_two_bins/constant_model_size/checkpoints/"
# SOURCE_DIR="data/outputs/"

# Target directory on the target computer
TARGET_USER="aagarwal2"
TARGET_HOST="txe1-login.mit.edu"
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/grasp_two_bins/constant_model_size/2_obs/checkpoints/latest.ckpt"
