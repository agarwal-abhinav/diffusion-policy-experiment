...
SOURCE_DIR="data/outputs/context_length_exp_adam_data_constant_model_size_scaled_gradients/"
...
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/planar_pushing/context_length_exp_adam_data_constant_model_size_scaled_gradients/12_obs"
