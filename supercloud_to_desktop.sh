...
SOURCE_DIR="data/outputs/grasp_two_bins/resnet_plus_transformer/cls_token_only/"
...
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/grasp_two_bins/resnet_plus_transformer/cls_token_only/20_obs"
