...
SOURCE_DIR="data/outputs/context_length_exp_adam_data_inception/16_obs_no_inception/"
# SOURCE_DIR="data/outputs/"

# Target directory on the target computer
TARGET_USER="aagarwal2"
TARGET_HOST="txe1-login.mit.edu"
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_inception/16_obs_no_inception/checkpoints"
# TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_inception/16_obs_no_inception/normalizer.pt"
# TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_constant_model_size"
