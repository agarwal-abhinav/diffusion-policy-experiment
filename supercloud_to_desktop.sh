...
SOURCE_DIR="data/outputs/context_length_exp_adam_data_constant_model_size_init_encoder/2_encoder_init/10_obs/"
# SOURCE_DIR="data/outputs/"

# Target directory on the target computer
TARGET_USER="aagarwal2"
TARGET_HOST="txe1-login.mit.edu"
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_constant_model_size_init_encoder/2_encoder_init/10_obs/checkpoints"
