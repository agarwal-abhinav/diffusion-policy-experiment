...
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/grasp_two_bins_flat/same_middle_same_return/attention_training/random_4_to_obs/22_obs/normalizer.pt"
