...
SOURCE_DIR="data/outputs/context_length_exp_adam_data_inception/12_obs_h_24_no_inception/"

# Target directory on the target computer
TARGET_USER="aagarwal2"
TARGET_HOST="txe1-login.mit.edu"
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_inception/12_obs_h_24_no_inception/checkpoints"
# TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_inception/12_obs_h_24_no_inception/normalizer.pt"
