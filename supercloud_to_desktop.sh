...
# SOURCE_DIR="data/outputs/long_context_planar_pushing/two_modes/unet_film/0_via_mirror/5_obs/"
SOURCE_DIR="data/outputs/long_context_planar_pushing/single_mode/unet_cross_attention/4_original/constant_obs_steps/5_obs/checkpoints/"
...
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/long_context_planar_pushing/single_mode/unet_cross_attention/4_original/constant_obs_steps/5_obs/checkpoints/latest.ckpt"
