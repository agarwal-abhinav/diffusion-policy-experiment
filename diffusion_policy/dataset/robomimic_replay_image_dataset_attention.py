...
class RobomimicReplayImageImprovedDatasetAttention(RobomimicReplayImageDataset): 
    def __init__(self, 
                 shape_meta: dict,
            dataset_path: str,
            horizon=1,
            ...
            training_mode='random' # 'random' or 'random_sprinkle'
                 ): 
        super().__init__(
            shape_meta=shape_meta,
            dataset_path=dataset_path,
        ...
        if self.training_mode == 'random_sprinkle': 
    ...
    def __getitem__(self, idx):
        ...
        data = self.sampler.sample_data(idx, key_first_k_override=key_first_k)
