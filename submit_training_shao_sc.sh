...
CONFIG_DIR=config/iros/planar_pushing/data_experiments/unet_film/data_320
CONFIG_NAME=2_obs.yaml
HYDRA_RUN_DIR=data/outputs/iros/planar_pushing/data_experiments/unet_film/data_320/2_obs
