...
# SOURCE_DIR="data/planar_pushing_cotrain/sim_sim_tee_data_carbon_large.zarr"
...
TARGET_DIR="/home/gridsan/aagarwal2/RLG/gcs-diffusion/data/outputs/context_length_exp_adam_data_constant_model_size/robomimic_resnet18_more_channels_from_scratch/"
