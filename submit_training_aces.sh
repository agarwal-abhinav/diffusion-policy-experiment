...
#SBATCH --job-name=Variable_length_sprinkle_resnet_init_12_obs #Set the job name to Example_SNMC_GPU
#SBATCH --time=15:30:00 #Set the wall clock limit to 15hr 30min
#SBATCH --nodes=1 #Request 1 nodes
#SBATCH --ntasks-per-node=10 #Request 16 tasks/cores per node
#SBATCH --mem=35G #Request 35 (488GB) per node
