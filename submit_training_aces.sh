...
#SBATCH --time=20:00:00 #Set the wall clock limit to 15hr 30min
...
#SBATCH --gres=gpu:a30:1 #Specify GPU(s) per node, 1 H100 GPUs
...
CONFIG_DIR=config/grasp_two_bins_flat_green/same_middle_same_return_green/basic_training
CONFIG_NAME=22_obs.yaml
HYDRA_RUN_DIR=data/outputs/grasp_two_bins_flat_green/same_middle_same_return_green/basic_training/22_obs
