...
# navigate to data/wrist_camera
frames = root["data"]["wrist_camera"]  # usually shape (T, H, W, C)

# select first 100 frames
frames100 = frames[:300]  # numpy-like slicing

# save first frame as PNG
first_frame = frames100[124]
imageio.imwrite("wrist_first.png", first_frame)

# write all 100 frames to MP4
out_path = "wrist_first100.mp4"
...
print("Saved first frame as wrist_first.png")
