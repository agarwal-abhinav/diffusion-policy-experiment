...
from data_generation.motion_planners.base_RRT_star import BaseRRTStar
from data_generation.maze.maze_environment import MazeEnvironment

class MazeRRTStar(BaseRRTStar):
    def __init__(self, 
...
def main():
    ...
    maze_rrt = MazeRRTStar(maze_env, source)

    # grow tree to goal
    path = maze_rrt.grow_to_goal(np.array([0.5, 4.5]), num_shortcut_attempts=100)
